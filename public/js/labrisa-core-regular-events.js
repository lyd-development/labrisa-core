/**
 * Front-end behaviour for the Labrisa Core "Regular Events" widget: a Swiper
 ...
 *
 * Structurally identical to labrisa-core-all-events.js except for the
 * widget/wrapper names it targets.
 */
( function () {
	'use strict';
	...
	if ( window.elementorFrontend && window.elementorFrontend.hooks ) {
		window.elementorFrontend.hooks.addAction(
			'frontend/element_ready/labrisa-regular-events.default',
			initWidget
		);
	} else {
		document.addEventListener( 'DOMContentLoaded', function () {
			document.querySelectorAll( '.labrisa-regular-events' ).forEach( initWidget );
		} );
	}
} )();
